class Skyline_Kit_Fridge extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								Furniture_Fridge_Kit1;
	
	void Skyline_Kit_Fridge()
	{
...
class Skyline_Fridge_Holo extends ItemBase
{
...
class Skyline_Fridge extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
