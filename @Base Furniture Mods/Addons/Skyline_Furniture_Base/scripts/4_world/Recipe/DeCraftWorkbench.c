class DeCraftWorkbench extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismount";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Skyline_Workbench");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Skyline_Kit_Workbench");//add results here
